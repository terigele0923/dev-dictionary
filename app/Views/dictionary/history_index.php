...
<div class="card">
    ...
    <table>
        <thead><tr><th>version</th><th>カテゴリ</th><th>メモタイプ</th><th>タイトル</th><th>ステータス</th><th>保存日時</th><th>操作</th></tr></thead>
        <tbody>
        <?php foreach ($histories as $history): ?>
            <tr>
                <td><?= e($history['version_no']) ?></td>
                <td><?= e($history['category_name']) ?></td>
                <td><?= e($history['memo_type_name'] ?? '-') ?></td>
        ...
        <?php endforeach; ?>
        <?php if (empty($histories)): ?><tr><td colspan="7">履歴はありません。</td></tr><?php endif; ?>
        </tbody>
    </table>
</div>
